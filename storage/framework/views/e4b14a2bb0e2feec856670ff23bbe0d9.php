...
<?php endif; ?>
    <div class="w-full p-2 bg-gray-100 border border-gray-300 border-dashed rounded" x-data="{ isUploading: false, progress: 0 }"
        ...
        <div x-show="!isUploading">
            ...
            <input type="file" class="hidden" accept="<?php echo e($fileTypes ?? ''); ?>"
                <?php echo e($multiple ?? false ? 'multiple' : ''); ?>
                        ...
                        <?php if($photo != null): ?>
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="font-light text-gray-500">
                                    ...
                                    <button wire:key="remove-photo-<?php echo e(rand(10, 3004)); ?>" type="button"
                                        wire:click="removePhoto(<?php echo e($key); ?>)"
...
<?php /**PATH D:\xampp8.1\htdocs\zuma backend\resources\views/livewire/component/multiple-media-upload.blade.php ENDPATH**/ ?>