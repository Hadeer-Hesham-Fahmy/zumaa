...
} elseif ($_instance->childHasBeenRendered('l414255104-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l414255104-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l414255104-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l414255104-0');
} else {
    $response = \Livewire\Livewire::mount('header.vendor-selector');
    $html = $response->html();
    $_instance->logRenderedChild('l414255104-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        <?php endif; ?>
...
<?php /**PATH /Users/ambrosetemidayobako/Desktop/Dev/web/fuodz-admin/resources/views/livewire/header/profile.blade.php ENDPATH**/ ?>