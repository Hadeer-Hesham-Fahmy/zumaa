            ...
            <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl ">
                <div class="flex flex-col overflow-y-auto md:flex-row">
                    <div class="h-32 md:h-auto md:w-1/2">
                        <img aria-hidden="true" class="object-cover w-full h-full" src="https://zumaa.app<?php echo e(setting('loginImage', asset('images/login-office.jpeg'))); ?>" alt="Office" />
                    </div>
...
} elseif ($_instance->childHasBeenRendered('l3049778534-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3049778534-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3049778534-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3049778534-0');
} else {
    $response = \Livewire\Livewire::mount('select.language-selector', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3049778534-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php /**PATH D:\xampp8.1\htdocs\zuma backend\resources\views/livewire/auth/login.blade.php ENDPATH**/ ?>