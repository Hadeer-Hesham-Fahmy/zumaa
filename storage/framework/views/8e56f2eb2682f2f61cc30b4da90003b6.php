...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l4082262471-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4082262471-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4082262471-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4082262471-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l4082262471-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'agreedVendor','defer' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'noMargin' => true]); ?> <span><?php echo e(__("I agree with")); ?> <a href="<?php echo e(route('terms')); ?>" target="_blank" class="font-bold text-primary-500 hover:underline"><?php echo e(__("terms and conditions")); ?></a></span>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php /**PATH D:\xampp8.1\htdocs\zuma backend\resources\views/livewire/auth/register/partials/vendor.blade.php ENDPATH**/ ?>