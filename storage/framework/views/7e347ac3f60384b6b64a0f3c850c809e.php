...
} elseif ($_instance->childHasBeenRendered('l4127149426-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4127149426-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4127149426-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4127149426-0');
} else {
    $response = \Livewire\Livewire::mount('settings.notification', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4127149426-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l4127149426-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4127149426-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4127149426-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4127149426-1');
} else {
    $response = \Livewire\Livewire::mount('settings.web-app-settings', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4127149426-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l4127149426-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l4127149426-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4127149426-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4127149426-2');
} else {
    $response = \Livewire\Livewire::mount('settings.page', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4127149426-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l4127149426-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l4127149426-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4127149426-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4127149426-3');
} else {
    $response = \Livewire\Livewire::mount('settings.custom-notification-message', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4127149426-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l4127149426-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l4127149426-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4127149426-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4127149426-4');
} else {
    $response = \Livewire\Livewire::mount('settings.file-limit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4127149426-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /Users/ambrosetemidayobako/Desktop/Dev/web/fuodz-admin/resources/views/livewire/settings/index.blade.php ENDPATH**/ ?>